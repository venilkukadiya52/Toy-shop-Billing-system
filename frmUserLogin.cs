    ...
    public partial class frmUserLogin : Form
    {
        ...
        private void btn_login_Click(object sender, EventArgs e)
        {
            if (IsValidate())
            {
                ...
                SqlCommand cmd = new SqlCommand("select ID from tblRegistration where UserName='" + Convert.ToString(txt_username.Text) + "' and Password='" + Convert.ToString(txt_password.Text) + "'", con);
